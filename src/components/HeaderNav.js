...
const HeaderNav = () => {
    return (
        <nav className="nav-main grid grid-cols-4 md:grid-cols-1 max-h-full tracking-widest text-xs lg:text-sm text-highlight md:grid-rows-4 grid-flow-row auto-rows-max">
        <Link
          to="/"
