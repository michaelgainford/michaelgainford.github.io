...
const MyProjectsMain = () => {
  ...
  return (
    <div className="main-projects">
      <div className="projects-wrapper grid lg:grid-cols-2">
          ...
          return (
            ...
            >
              <a
                ...
                className="p-2 sm:p-8 md:p-16  hover:md:p-8 text-light hover:text-highlight ease-in-out duration-500"
              >
                <img
                ...
                />
                <p className="text-center tracking-widest uppercase text-xs p-2 sm:p-4 md:p-8 w-full">
