            ...
            <div className="w-full flex flex-row xs:flex-col">
              <div className="md:w-full overflow-hidden bg-teal-700 md:rounded-t-lg resource-image">
                <Image
                  ...
                  alt={resource.name}
                  className="z-0 w-full h-full object-cover max-w-full overflow-hidden transition duration-300 md:rounded-t-lg lg:opacity-90 group-hover:opacity-100 aspect-[5/3]"
                  height={320}
                  width={600}
                  priority={index < 5}
                />
