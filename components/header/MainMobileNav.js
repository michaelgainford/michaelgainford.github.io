...
export default function MainMobileNav({ isVisible, toggleVisibility }) {
  ...
  return (
    <div
      className={`mobile-nav absolute inset-0 z-50 w-full h-full p-8 bg-slate-900 lg:hidden flex flex-col gap-8 overscroll-y-contain ${
        isVisible ? "" : "hidden"
      }`}
    >
