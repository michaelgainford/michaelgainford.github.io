  ...
  return (
		<div className="columns-3xs gap-x-4 lg:gap-x-8 mb-16" >
			{DataForQuotes.map((quote, index) => (
				<div key={index} className="p-6 space-y-4 text-center mb-8 break-inside-avoid border border-sky-400 rounded-md bg-white text-sky-900 flex items-center max-sm:w-full lg:p-8 shadow-md shadow-sky-200 hover:bg-sky-700 hover:text-sky-100  hover:-translate-y-1 transition-all duration-500 ease-in-out max-sm:max-w-[75%] mx-auto hover:rounded-xl">
