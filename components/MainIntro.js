    ...
    <div className="pt-8 intro">
      <div className="grid grid-cols-1 lg:gap-32 lg:grid-cols-8">
        <div className="flex flex-col justify-center col-span-1 text-base text-left lg:col-span-5 intro-left lg:pr-8 ">
          <h1 className="lg:border-l-4 lg:border-slate-800 lg:pl-8 text-sm tracking-wide text-left font-medium lg:text-3xl text-slate-400 py-4 lg:pt-8 leading-relaxed">Hi! Thank you for visiting michaelgainford.dev</h1>
          <p className="lg:border-l-4 lg:border-slate-800 lg:pl-8 text-sm font-light leading-loose tracking-wider text-slate-400 py-2 lg:pb-8">
