    ...
    <div className="intro">
      <div className="grid grid-cols-1 lg:gap-32 lg:grid-cols-8">
        <div className="flex flex-col justify-center col-span-1 text-base text-left rounded-lg border-slate-800 lg:col-span-5 intro-left lg:pr-8">
          <h1 className="py-2 text-sm font-light leading-relaxed tracking-wide text-center sm:text-left sm:text-base lg:border-l-4 max-lg:mt-4 max-lg:font-bold lg:border-transparent decoration-8 lg:font-medium md:text-xl lg:text-3xl text-slate-400">Hi! Thank you for visiting <span className="underline underline-offset-4 decoration-slate-800">michaelgainford.dev</span></h1>
          <p className="py-2 text-xs font-light text-center md:text-left !leading-loose tracking-wider lg:border-l-4 lg:border-transparent md:text-sm text-slate-400">
