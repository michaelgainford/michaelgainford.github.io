		...
		<div className={`w-full pb-8 intro lg:pb-8 xl:pb-12 2xl:pb-16`}>
			<div className={`grid grid-cols-8`}>
				...
				<details className={detailsStyles}>
					...
					<p className={`pt-4 text-xs font-light text-left !leading-loose tracking-wider text-slate-400 text-balance mb-4 sm:py-2 md:text-sm lg:border-l-4 lg:border-transparent`}>
