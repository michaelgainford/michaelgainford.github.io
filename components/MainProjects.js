export default function MainProjects() {
  return (
    <div className="projects-list border-blue-500">
    <h2 className="h2">Projects</h2>
    <div className="grid grid-cols-2 gap-4 lg:gap-6 md:grid-cols-3 lg:grid-cols-4">
      <a href="dev-resources.html"
        className="flex flex-col items-center justify-center gap-4 font-light tracking-wide transition border rounded-lg group/resources project border-teal-700/80 bg-slate-800 hover:bg-teal-800 text-slate-400  aspect-[3/2]">
      ...
      <a href="movies-database.html"
        className="flex flex-col items-center justify-center gap-4 font-light tracking-wide transition border rounded-lg group/movies hover:bg-violet-700 border-violet-700/80 project bg-slate-800 text-slate-400 aspect-[3/2]">
        <span className="w-10 h-auto lg:w-16 lg:h-auto max-lg:fill-slate-100 lg:fill-slate-500 group-hover/resources:fill-slate-100">
      ...
      <a href="euro-2024.html"
        className="flex flex-col items-center justify-center gap-4 text-xl font-light tracking-wide transition border border-blue-700/80 rounded-lg group/euros hover:bg-blue-700 project bg-slate-800 text-slate-400 aspect-[3/2]">
        <span className="w-10 h-auto lg:w-16 lg:h-auto max-lg:fill-slate-100 lg:fill-slate-500 group-hover/resources:fill-slate-100">
      ...
      <a href="jokes.html"
        className="flex flex-col items-center justify-center gap-4 text-xl font-light tracking-wide transition border rounded-lg border-rose-700/80 group/euros hover:bg-rose-700 project bg-slate-800 text-slate-400 aspect-[3/2]">
