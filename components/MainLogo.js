export default function MainLogo() {
  return (
    <div className="logo flex gap-4">
      <span className="w-6 h-6 title-icon !fill-yellow-600">
      ...
      <span className="text-base font-medium tracking-wider text-left uppercase lg:text-xl text-slate-300">Michael&apos;s Dev Site</span>
    </div>
  ) 
}