export default function MainLogo() {
  return (
    <div className="flex items-center gap-2 max-md:justify-center logo">
      ...
      <span className="text-sm font-light tracking-wider text-left uppercase lg:text-base text-slate-300">Michael&apos;s Dev Site</span>
    </div>
  ) 
}