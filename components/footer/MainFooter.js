...
export default function mainFooter() {
  return (
    <footer className="w-[90%] md:w-[92%] lg:-[95%] max-w-[2000px] flex flex-col lg:justify-between gap-1 pt-6 lg:pt-4 2xl:pt-24 mx-auto header-content lg:pb-2 lg:gap-4 tracking-wider">
