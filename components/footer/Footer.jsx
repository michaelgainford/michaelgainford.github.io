...
export default function FOOTER(customTextColour) {
	return (
		<footer className={`w-full`}>
		<div className={`w-[90%] md:w-[92%] lg:-[95%] max-w-[2000px] flex flex-col gap-1 pt-6 tracking-wider mx-auto md:mt-8 lg:pb-2 lg:gap-4 lg:justify-between lg:pt-16 2xl:pt-24`}>
