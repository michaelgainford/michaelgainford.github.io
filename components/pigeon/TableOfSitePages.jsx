	...
	return (
		<div className="overflow-x-auto">
			<table className="w-full max-w-[1800px] mx-auto mt-8 mb-16 text-left text-md xl:max-w-[90dvw]">
				<thead className="text-xxs lg:text-sm">
				...
				<tbody className="text-xxs xl:text-sm">
					{PagesInSitemap.map((item, index) => (
						...
						>
							...
							<td>
								<span className="px-2 py-1 font-bold w-full tracking-wider text-center rounded-lg relative flex">
									<span
