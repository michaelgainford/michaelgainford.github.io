...
import { mainStyles, globalPageStyles } from "@/components/data/Variables";
        		...
        		<div className={mainStyles}>
          			<div className="flex flex-col w-full gap-12 max-lg:pt-12 club-info">
						...
						<div className="pb-16 mt-16 club-summary">
							...
							<p className="text-sm max-lg:text-center lg:text-base">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Doloribus adipisci numquam ut sint excepturi natus, autem doloremque perspiciatis dolorum soluta aliquid, nulla laboriosam? Hic cum beatae commodi rem. Fuga accusamus, quibusdam nostrum dolorem maxime numquam! Harum necessitatibus officia nesciunt molestiae.</p>
						</div>
					</div>
				</div>
			</main>
