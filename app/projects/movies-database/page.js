...
const watchedMovies = MoviesList.filter((movie) => movie.watched === true);
const unwatchedMovies = MoviesList.filter((movie) => movie.watched === false);
  ...
  return (
    <div className="bg-indigo-950 text-slate-300">
      ...
      <main className={mainStyles}>
        <H1 text="Movies Database (Watched)" />
        <div className="movies-grid w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 3xl:grid-cols-8 gap-4 max-sm:gap-y-6 md:gap-6 lg:gap-8 xl:gap-12">
        ...
        <div className="w-full border border-indigo-900/50  rounded-lg p-4 my-8 lg:my-16 ">
          ...
          <div className="min-h-[100px] movies-grid w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 3xl:grid-cols-8 gap-4 max-sm:gap-y-6 md:gap-6 lg:gap-8 xl:gap-12">
