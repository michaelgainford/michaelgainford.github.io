...
import TableOfSitePages from "@/components/pigeon/TableOfSitePages";
import Footer from "@/components/footer/_Footer";

export const metadata = {
	title: "Site Maintenance Tracker",
	description:
		"A list of all the pages on this website, along with the last time they were updated.",
};

export default function Page_SiteMaintenanceTracker() {
	return (
		<div
			className={`${globalPageStyles} ${brandPageBackground} ${brandTextColour}`}
		>
			<Header />
			<main className={`${globalWrapperFixedWidth}`}>
				<div
					className={`flex flex-col w-full justify-center text-center max-w-[1800px]`}
				>
					<H1
