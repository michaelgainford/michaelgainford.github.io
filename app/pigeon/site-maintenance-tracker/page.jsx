		...
		<div className={`${globalPageStyles} ${pageStyles}`}>
			...
			<main className={`${mainStyles}`}>
				<div className="flex flex-col w-full justify-center text-center motion motion-preset-slide-up motion-delay-[1000ms] motion-duration-500 max-w-[1800px]">
					<H1 text={`Site Maintenance Tracker`} font_sizes={``} other_classes={`${sharedHeadingStyles} max-lg:-mt-4 text-balance !text-sm lg:!text-xl 2xl:!text-3xl xl:!mb-0 border-none text-center flex justify-center`} />
					<TableOfSitePages />
				</div>
			</main>
			<Footer />
